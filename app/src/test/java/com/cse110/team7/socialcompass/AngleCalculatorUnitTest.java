...
public class AngleCalculatorUnitTest {
    ...
    public void calculate() {
        double angle = AngleCalculator.calculateAngle(GEISEL_LIBRARY, COMPUTER_SCIENCE_BUILDING);
        assertEquals(79.639864, angle, .1);
    }
}
